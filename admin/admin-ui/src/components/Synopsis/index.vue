    ...
    <div v-if="ww" class="specialBox specialBox1 overviewBox Synopsis ">
      ...
      <el-card class="box-card">
        ...
        <div class="topLeft">
          ...
          <div class="topLeft-item" style="cursor:normal;">
      ...
      <el-card class="box-card alarmBox">
        ...
        <el-row style="height: 100%">
          ...
          <el-col v-if="ww && show" :span="12" style="height: 100%">
      ...
      <el-card v-if="activeName" class="box-card topFiveBox">
        <el-tabs v-model="activeName" v-loading="top5loading" type="card">
          <el-tab-pane v-for="item in top_list" :key="item.topN_title" :label="item.topN_title" :name="item.topN_title">
            <div v-if="activeName == item.topN_title && linedata.options.length > 0 && show" style="height: 100%;width:100%">
        ...
        <el-collapse v-model="activeCollapse">
          <el-collapse-item title="设备列表" name="1">
            ...
            <div class="tableBox-right">
              <el-table v-loading="loading1" :height="ww > 1400 ? 410 : 265" :data="dataList" empty-text=" " element-loading-text="拼命加载中..." border @row-dblclick="turnPage" @sort-change="getOrder">
            ...
            <div v-if="showCheck" style="padding:15px;padding-top:0px">
              ...
              <div v-if="labelPosition === 'left'" style="padding-top:10px;height:37vh;overflow:auto;">
                <el-table :data="tableData" border :height="310" style="width: 100%;">
                  <template v-if="!loading" slot="empty" style="height: 300px;">
...
import { getNetworkResource, getNumByAlarmLevel, getNumByAlarmState, getTop5DataGroupByHost, getServerOverview, getResourceCount, getTotalAlarmAsset, getTotalAlarmAssetNum, getAlarmList, updatePropertyconcern, getKeys, getAlarmCategory, getResourceSonClassId } from '@/api/operation/serverOverview'
export default {
  name: 'Synopsis',
  // props: {p
  //   className: {
    ...
    getAlarmList() {
      ...
      getAlarmList({
        ...
        if (res.datas.length) {
          ...
          //   engine: ''
          // }).then((response) => {
          //   item.EventCategory = response.datas[0].label_text || ''
          //   if (index === response.datas.length - 1) {
          //     this.dataListAlarm = res.datas
          //     this.loading = false
          //   }
          // })
