        ...
        <el-form ref="ruleForm" :model="ruleForm" :rules="rules" label-width="100px" class="demo-ruleForm">
          ...
          <el-col v-show="activeIndex == '3'" :span="24" style="padding: 10px;overflow: auto;height: 530px;">
            ...
            <div v-if="ruleForm.rule_type === 'Z'">
              <el-row>
                <el-col :span="12">
                  <el-form-item label="长周期压缩" prop="params">
                    <el-radio-group v-model="ruleForm.params.isLongCycleCompress" :disabled="disable">
              ...
              <el-form-item label="结果字段" prop="effect">
...
export default {
  ...
  data() {
    return {
      ...
      effectExper: [{ columnInDB: 'LastOccurrence', columnName: '最后发生时间' }, { columnInDB: 'Tally', columnName: '发生次数' }, { columnInDB: 'Summary', columnName: '内容' }],
      effectExperCondition: [],
      ...
      ruleForm: {
        ...
        remark: '',
        displayOrder: 0,
        params: { cycleTime: 30, isLongCycleCompress: 'Y' }
      },
      saveOrUpdate: 'save',
      once: true,
      twice: false,
  ...
  methods: {
    ...
    getEventColumnDefine() {
      getEventColumnDefine({
        ...
        this.effectExperCondition = response.datas
        // this.effectExper=[{"columnInDB":"LastOccurrence","columnName":"最后发生时间"},{"columnInDB":"Tally","columnName":"发生次数"},{"columnInDB":"Summary","columnName":"内容"}];
      })
    },
    // 获取页面高度
    getOperateBoxHeight() {
    ...
    IsActive(value) {
      // if (value === '3' && !this.ruleForm.name) {
      //   this.activeIndex = '2'
      //   this.msgSuccess('请先填写策略名称')
      // } else {
