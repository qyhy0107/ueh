    ...
    <div ref="OperateBox" class="operateBox">
      <el-form :inline="true" :model="formInline" label-position="left" @submit.native.prevent>
        ...
        <el-form-item label="最后修改时间">
          <el-date-picker v-model="formInline.time" style="width:480px" clearable size="small" type="datetimerange"
            range-separator="至" start-placeholder="开始日期" end-placeholder="结束日期" value-format="timestamp"
            @change="onSearch" />
        </el-form-item>
        <el-form-item label="最后修改人">
          <el-input v-model.trim="formInline.userName" clearable size="small" placeholder="请输入名称"
            @keyup.enter.native="onSearch" />
        </el-form-item>
        <el-form-item>
          ...
          <el-col v-show="activeIndex == '3'" :span="24" style="padding: 10px;overflow: auto;height: 530px;">
            ...
            <div v-if="ruleForm.rule_type === 'U'">
              <el-form-item label="事件源类型" prop="event_source_type">
                <el-select v-model="ruleForm.event_source_type" :disabled="disable" placeholder="请选择事件源"
              ...
              <el-form-item label="条件字段" prop="expression">
                <el-table :show-header="status" :data="ruleForm.expression">
                  ...
                  <el-table-column label="值">
                    <template slot-scope="scope">
                      <el-select v-model="scope.row.conditionColumn" placeholder="请选择条件字段" clearable size="small"
                        ...
                        ">
                        <el-option v-for="item in effectExper" :key="item.columnName" :label="item.columnName"
                          :value="item.columnInDB" />
                      </el-select>
                    </template>
                  </el-table-column>
                  ...
                  <el-table-column label="操作">
                    <template slot-scope="scope">
                      <el-select v-if="scope.row.conditionDataType == 'INT' || scope.row.conditionDataType == 'FLOAT'"
                  ...
                  <el-table-column label="逻辑操作">
                    <template slot-scope="scope">
                      <el-select v-model="scope.row.operatorLogic" placeholder="请继续" clearable :disabled="disable"
                  ...
                  <el-table-column label="操作" prop="name" class-name="small-padding fixed-width">
                    <template slot-scope="scope">
                      ...
                      <el-button
                        ...
                        class="el-icon-circle-plus-outline" size="mini" type="text" :disabled="disable" @click="addExpreClick()">新增</el-button>
                    </template>
                  </el-table-column>
                </el-table>
              </el-form-item>
              <el-form-item label="结果" prop="effect[0].effectValue">
                <el-select v-model="ruleForm.effect[0].effectValue" :disabled="disable" size="small" placeholder="级别内容"
            ...
            <div v-if="ruleForm.rule_type === 'D'">
              ...
              <el-form-item label="条件字段" prop="expression">
                <el-table :show-header="status" :data="ruleForm.expression">
                  ...
                  <el-table-column label="值">
                    <template slot-scope="scope">
                      <el-select v-model="scope.row.conditionColumn" :disabled="disable" placeholder="请选择条件字段" clearable
                        size="small" @change="
                          columnChange(scope.row)
                          setFormular(scope.row.conditionColumn)
                        ">
                  ...
                  <el-table-column label="值">
                    <template slot-scope="scope">
                      <el-date-picker v-if="scope.row.conditionDataType == 'LONGTIMESTAMP'"
                        v-model="scope.row.conditionValue[0]" value-format="timestamp" size="small" type="datetimerange"
                        range-separator="-" start-placeholder="开始日期" end-placeholder="结束日期" clearable
                        class="specialDateClass" />
                      <el-input-number
                        v-else-if="(scope.row.conditionDataType == 'INT' || scope.row.conditionDataType == 'FLOAT') && scope.row.operator != 'between' && scope.row.conditionColumn != 'Severity' && scope.row.conditionColumn != 'OldSeverity'"
                        v-model="scope.row.conditionValue[0]" size="small" placeholder="请输入内容" clearable
                        style="width:100%" controls-position="right" :min="1" />
                      <el-select
                        v-else-if="(scope.row.conditionDataType == 'INT' || scope.row.conditionDataType == 'FLOAT') && scope.row.operator != 'between' && (scope.row.conditionColumn == 'Severity' || scope.row.conditionColumn == 'OldSeverity') && scope.row.operator !== 'in'"
                        v-model="scope.row.conditionValue[0]" :disabled="disable" size="small" :multiple="false"
                        placeholder="请选择级别内容" clearable>
                      ...
                      <el-row
                        ...
                        :gutter="4">
                        <el-col :span="11">
                          <el-input-number v-model="scope.row.conditionValue[0]" size="small" placeholder="最小值"
                            clearable style="width:100%" controls-position="right" :min="1" />
                        </el-col>
                        <el-col :span="2" style="text-align: center; line-height: 2rem">
                          <span>-</span>
                        ...
                        <el-col :span="11">
                          <el-input-number v-model="scope.row.conditionValue[1]" size="small" placeholder="最大值"
                            clearable style="width:100%" controls-position="right" :min="1" />
                        </el-col>
                      </el-row>
                      <el-input v-else v-model.trim="scope.row.conditionValue[0]" :disabled="disable" placeholder="默认值"
