    ...
    <div ref="OperateBox" class="operateBox">
      <el-form ref="queryForm" :model="queryParams" :inline="true" label-position="left">
        ...
        <el-form-item label="参数名称" prop="dictLabel">
          <el-input v-model.trim="queryParams.dictLabel" placeholder="请输入参数名称" size="small"
        ...
        <el-form-item>
          <el-button v-hasPermi="['system:dict:add']" class="grayButton" icon="el-icon-plus" size="mini"
            @click="handleAdd">新增</el-button>
          <el-button v-hasPermi="['system:dict:remove']" class="grayButton" icon="el-icon-delete" size="mini"
            :disabled="multiple" @click="handleDelete">批量删除</el-button>
        </el-form-item>
      </el-form>
    </div>
    <div class="showTableBox" :style="{height:OperateBoxHeight+'px'}">
      <el-table empty-text=" " element-loading-text="拼命加载中..."   v-loading="loading" :data="dataList" @selection-change="handleSelectionChange"
        ...
        <el-table-column label="参数组名称" sortable align="left
        " prop="dictType" width="200">
          <template slot-scope="scope">
            {{ scope.row.dictName }}
          </template>
        </el-table-column>
        <el-table-column label="参数名称" sortable align="left
        " prop="dictLabel" :show-overflow-tooltip="true" min-width="150" />
        <el-table-column label="参数值" sortable align="left
        " prop="dictValue" :show-overflow-tooltip="true" min-width="150" max-width="250" />
        ...
        <el-table-column label="备注" sortable align="left" header-align="left
        " prop="remark" :show-overflow-tooltip="true" min-width="100" max-width="250" />
        <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
          <template slot-scope="scope">
            <el-button v-hasPermi="['system:dict:edit']" size="mini" type="text" icon="el-icon-edit"
              @click="handleUpdate(scope.row)">修改</el-button>
            <el-button v-hasPermi="['system:dict:remove']" size="mini" type="text" icon="el-icon-delete"
      ...
      <pagination v-show="total>0" :total="total" :page.sync="queryParams.pageNum" :limit.sync="queryParams.pageSize"
        :page-sizes="[10, 20, 50, 200]" @pagination="getList" />
    </div>
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px">
      <el-form ref="form" :model="form" :rules="rules" label-width="100px">
        ...
        <el-form-item label="参数值" prop="dictValue">
          <el-input v-model.trim="form.dictValue" placeholder="请输入数据键值" size="small" />
        </el-form-item>
        <el-form-item label="显示顺序" prop="dictSort">
          <el-input-number v-model="form.dictSort" controls-position="right" :min="10" size="small" />
        </el-form-item>
