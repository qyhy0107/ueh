...
import com.china.alert.project.system.mapper.SysDictDataMapper;
...
//    private int expireTime;
    ...
    @Autowired
    private ISysRedisToDBService sysRedisToDBService;
    ...
    public LoginUser getLoginUser(HttpServletRequest request) {
        ...
        if (StringUtils.isNotEmpty(token)) {
            ...
            boolean redisFlag = sysDictTypeService.selectDictTypeByStatus(Constants.SYS_REDIS);
            LoginUser user = null;
            if (redisFlag) {
                //user = redisCache.getCacheObject(userKey);
            } else {
                user = sysRedisToDBService.getCacheObject(userKey);
            }
            return user;
        }
        return null;
        ...
        if (StringUtils.isNotNull(loginUser) && StringUtils.isNotEmpty(loginUser.getToken())) {
            ...
            if (redisFlag) {
               // redisCache.setCacheObject(userKey, loginUser);
                ...
                sysRedisToDBService.setCacheObject(userKey, loginUser,loginUser.getExpireTime());
            }
    ...
    public void delLoginUser(String token) {
        if (StringUtils.isNotEmpty(token)) {
            ...
            if (redisFlag) {
                ...
                sysRedisToDBService.deleteObject(userKey);
            }
        }
    }
    ...
    public void refreshToken(LoginUser loginUser) {
        ...
        String time = sysDictDataMapper.selectdictValue(Constants.SYS_SESSION_TIMEOUT);
        int expireTime =30;
        ...
        if (redisFlag) {
            ...
            sysRedisToDBService.setCacheObject(userKey, loginUser, expireTime, TimeUnit.MINUTES,loginUser.getExpireTime());
        }
    }
