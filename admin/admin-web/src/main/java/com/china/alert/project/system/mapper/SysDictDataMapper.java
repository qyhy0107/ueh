...
public interface SysDictDataMapper {
    ...
    public SysDictData selectDictDataByTypeAndLabel(SysDictData dictData);
    /**
     * 返回的是一个对象
     *
     * @param dictType
     * @return
     */
    public SysDictData selectDictDataByDictType(String dictType);
