 ...
 * @Package com.china.alert.project.tool.swagger.dto
 */
public class ProcMonitor implements IExcelModel {
    ...
    @ExcelEntity
    private ProcMonitorParam monitorParam;
    ...
    public ProcMonitorParam getMonitorParam() {
        return monitorParam;
    }

    public void setMonitorParam(ProcMonitorParam monitorParam) {
