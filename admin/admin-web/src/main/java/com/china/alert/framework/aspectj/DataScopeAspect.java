...
import com.china.alert.framework.aspectj.lang.annotation.DataScope;
...
public class DataScopeAspect {
    ...
    // 配置织入点
    @Pointcut("@annotation(com.china.alert.framework.aspectj.lang.annotation.DataScope)")
    ...
    public static void dataScopeFilter(JoinPoint joinPoint, SysUser user, String deptAlias, String userAlias) {
        ...
        for (SysRole role : user.getRoles()) {
            ...
            if (DATA_SCOPE_ALL.equals(dataScope)) {
                ...
                sqlString.append(StringUtils.format(" OR {}.dept_id IN ( SELECT dept_id FROM sys_dept WHERE dept_id = {} or to_char({},'FM9999') = any(regexp_split_to_array(ancestors,',')))",
