 ...
 * @Package com.china.alert.project.tool.swagger.dto
 */
public class PortMonitor implements IExcelModel {
    ...
    @ExcelEntity
    private PortMonitorParam monitorParam;
    ...
    public PortMonitorParam getMonitorParam() {
        return monitorParam;
    }

    public void setMonitorParam(PortMonitorParam monitorParam) {
